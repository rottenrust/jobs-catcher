...
def upgrade():
    ...
    _add_column_if_missing("vacancies", sa.Column("published_at", sa.String(40), nullable=False, server_default=""))
    _add_column_if_missing("vacancies", sa.Column("updated_at", sa.String(40), nullable=False, server_default=""))
